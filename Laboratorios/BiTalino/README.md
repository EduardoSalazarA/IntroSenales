...
<h2 id="conex">Conexión</h1>
  ...
  Dicha señal eléctrica es amplificada en el módulo BITalino que cuenta con un amplificador de instrumentación. Además el módulo cuenta también con un filtro pasa-banda que elimina el ruido, como interferencias eléctricas o señales de alta frecuencia generadas por el movimiento del paciente.
  <p align="center"><img src="../../Imagenes/imagprincipal.jpg" width="500"></p>
